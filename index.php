...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <form action="includes/login.inc.php" method="POST">
          ...
          <p class=" w3l-register-p">Login as<a href="login-hostel_manager.php" class="register"> Hostel-wrden/Admin</a></p>
        <p class=" w3l-register-p">Don't have an account?<a href="signup.php" class="register"> Sign up</a></p>
    </div>
    <footer>
        <p class="copyright-agileinfo"> &copy; 2023 Mini Project. All Rights Reserved | Design and Developed by Mischif Coders.Co</p>
    </footer>
