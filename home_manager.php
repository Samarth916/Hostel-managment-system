...
<header>
	<div class="container agile-banner_nav">
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			...
			<h1><a class="navbar-brand" href="home_manager.php">MCE <span class="display"></span></a></h1>
			...
			<div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item active">
					<a href="http://127.0.0.1/student-attendance-management-system/"><button>Attendance</button></a>
					</li>s
					<li class="nav-item">
...
<footer class="py-5">
	<div class="container py-md-5">
		<div class="footer-logo mb-5 text-center">
			<a class="navbar-brand"  href="https://www.mcehassan.ac.in/" target="_blank">MCE<span class="display"> Hassan</span></a>
		</div>
